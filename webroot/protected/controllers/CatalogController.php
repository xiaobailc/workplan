...
class CatalogController extends XAdminBase
{
    /**
     * 首页
     */
    ...
    public function actionCreate ()
    {
        ...
        if (isset($_POST['Catalog'])) {
            ...
            if ($model->save()) {
                ...
                parent::_adminLogger(array('catalog'=>'create', 'intro'=>'添加全局分类,ID:'.$id.'名称：'.$model->catalog_name));
    ...
    public function actionUpdate ($id)
    {
        ...
        if (isset($_POST['Catalog'])) {
            ...
            if ($model->save()) {
                XXcache::refresh('_catalog');
                parent::_adminLogger(array('catalog'=>'update', 'intro'=>'编辑全局分类,ID:'.$model->id.',名称：'.$model->catalog_name));
                $this->redirect(array ('index' ));
            }
        }
    ...
    public function actionBatch ()
    {
        ...
        switch ($command) {
            case 'delete':
                ...
                parent::_adminLogger(array('catalog'=>'delete', 'intro'=>'删除全局分类，ID:'.$ids));
