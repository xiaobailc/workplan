...
class PostController extends XAdminBase
{
    /**
     * 首页
     *
    ...
    public function actionCreate() {
        ...
        if ( isset( $_POST['Post'] ) ) {
            ...
            if ($model->save() ) {
                ...
                parent::_adminLogger( array ( 'catalog' => 'create' , 'intro' => '添加内容,ID:' . $model->id ) ); 
    ...
    public function actionUpdate( $id ) {
        ...
        if ( isset( $_POST['Post'] ) ) {
            ...
            if ( $model->save() ) {
                ...
                parent::_adminLogger( array ( 'catalog' => 'update' , 'intro' => '编辑内容,ID:' . $id ) ); 
                $this->redirect( array ( 'index' ) );
            }
        }
        $attrModel = Attr::lists( $model->catalog_id, 'post' );
    ...
    public function actionCommentUpdate( $id ) {
        ...
        if ( isset( $_POST['PostComment'] ) ) {
            ...
            if ( $model->save() ) {
                parent::_adminLogger( array ( 'catalog' => 'update' , 'intro' => '编辑内容评论，ID:' . $id ) ); 
    ...
    public function actionSpecialCreate() {
        ...
        if ( isset( $_POST['Special'] ) ) {
            ...
            if ( $model->save() ) {
                self::_adminLogger( array ( 'catalog' => 'update' , 'intro' => '专题添加：' . $this->id .',ID:' . $id ) ); 
    ...
    public function actionSpecialUpdate( $id ) {
        ...
        if ( isset( $_POST['Special'] ) ) {
            ...
            if ( $model->save() ) {
                self::_adminLogger( array ( 'catalog' => 'update' , 'intro' => '专题更新,ID:' .$model->id ) ); 
                $this->redirect( array( 'special' ) );
            }
        }
