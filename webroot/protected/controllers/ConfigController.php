...
class ConfigController extends XAdminBase
{
    ...
    private function _updateData ($data, $scope = 'base')
    {
        if (XUtils::method() == 'POST') {
            ...
            parent::_adminLogger(array ('catalog' => 'update' , 'intro' => '更新系统配置，模块：' . $this->action->id )); 
    ...
    public function actionBatch ()
    {
        ...
        switch ($command) {
            ...
            case 'sendTplDelete':
                ...
                parent::_adminLogger(array ('catalog' => 'delete' , 'intro' => '删除信息模板，ID:' . $ids )); 
