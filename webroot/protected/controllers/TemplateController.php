...
class TemplateController extends XAdminBase
{
    /**
     * 首页
     */
    ...
    public function actionUpdateTpl( $filename ) {
        ...
        if ( isset( $_POST['content'] ) ) {
            ...
            if ( $fileputcontent == true ) {
                parent::_adminLogger( array( 'catalog'=>'update', 'intro'=>'编辑模板' ) );
    ...
    public function actionBatch() {
        ...
        case 'deleteFile':
            ...
            @unlink( $filePath );
            parent::_adminLogger( array( 'catalog'=>'delete', 'intro'=>'删除模板，ID:'.$fileName ) );
            $this->redirect( array( 'index' ) );
            break;
        case 'deleteFolder':
            ...
            if ( rmdir( $folderPath ) ) {
                parent::_adminLogger( array( 'catalog'=>'delete', 'intro'=>'删除文件夹，ID:'.$folderName ) );
