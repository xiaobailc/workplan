...
class DatabaseController extends XAdminBase
{
    ...
    public function init ()
    {
        parent::init();
        $this->_db = Yii::app()->db;
        $this->_bakupPath = WEBROOT.'/data/dbbak/';
        ...
        if ($this->_gets->getParam('dosubmit')) {
            ...
            if (is_array($sqlfiles)) {
                ...
                foreach ($sqlfiles as $id => $sqlfile) {
                    if (preg_match("/(icc_[0-9]{8}_[0-9a-z]{4}_)([0-9]+)\.sql/i", basename($sqlfile), $num)) {
