    ...
    public function actionEnv ()
    {
       ...
       $isWritable = array(
            ...
            array(
                '附件上传目录(uploads)',
                false,
                self::_isWritable(WEBROOT.DS.'uploads'),
                '附件上传',
                '若无附件上传可不用写权限'
            ),
            array(
                '数据目录(data)',
                false,
                self::_isWritable(WEBROOT.DS.'data'),
                '数据库备份',
                '若不备份数据库可不用写权限'
            ),
            array(
                ...
                false,
                self::_isWritable(WEBROOT.DS.'protected'.DS.'config'),
                '安装程序',
                '若手动安装系统写可不用写权限'
            ),
            array(
                '公共资源文件(assets)',
                true,
                self::_isWritable(WEBROOT.DS.'assets'),
                '系统核心',
                '必须可读写'
            ),
