...
class AttrController extends XAdminBase
{
    /**
     * 属性首页
     */
    ...
    public function actionCreate ()
    {
        ...
        if (isset($_POST['Attr'])) {
            ...
            if ($model->save()) {
                parent::_adminLogger(array ('catalog' => 'create' , 'intro' => '添加属性，ID:' . $model->id ));
    ...
    */
    public function actionUpdate ($id)
    {
        ...
        if (isset($_POST['Attr'])) {
            ...
            if ($model->save()) {
                parent::_adminLogger(array ('catalog' => 'update' , 'intro' => '编辑属性，ID:' . $id ));
                $this->redirect(array ('index' ));
            }
        }
    ...
    public function actionBatch ()
    {
        ...
        switch ($command) {
            case 'delete':
                ...
                parent::_adminLogger(array ('catalog' => 'delete' , 'intro' => '属性删除，ID:' . $ids )); 
