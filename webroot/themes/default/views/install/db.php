  ...
  <form name="dbInfo" id="dbInfo" method="post" action="<?php echo $this->createUrl('progress')?>">
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><input value="icc" type="text" name="dbName" id="dbName" class="class_input validate[required]" /> <span class="cnote">请先创建数据库</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input value="icc_" type="text" name="tbPre" id="tbPre" class="class_input" />
          <span class="cnote">同一数据库运行多个程序时，请修改前缀</span></td>
      </tr>
    </table>
    <h2 class="install_title">填写用户信息</h2>
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <th width="25%" height="30" align="right">用户账号：</th>
        <td><input value="" type="text" name="username" id="username" class="class_input validate[required]" /></td>
      </tr>
      <tr>
        <th height="30" align="right">用户密码：</th>
      ...
      <tr>
        <th height="30" align="right">用户邮箱：</th>
