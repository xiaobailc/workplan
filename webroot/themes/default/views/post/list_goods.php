      ...
      <div class="listBox clear">
        <ul>
         <?php foreach((array)$iccDataList as $iccKey=>$iccRow):?>
          <li class="full cl ">
            <div class="b_img"><a href="<?php echo $this->createUrl('post/show',array('id'=>$iccRow->id))?>" target="_blank"><img src="<?php echo $this->_baseUrl?>/<?php echo $iccRow->attach_thumb?>" alt="<?php echo $iccRow->title?>" class="tn"></a></div>
            <h2><a href="<?php echo $this->createUrl('post/show',array('id'=>$iccRow->id))?>" target="_blank" style=""><?php echo $iccRow->title?></a>fff </h2>
          </li>
          <?php endforeach?>
        </ul>
      </div>
