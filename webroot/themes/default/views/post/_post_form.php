...
<table class="form_table">
  ...
  <tr >
    <td ><select name="Post[catalog_id]" id="Post_catalog_id" onchange="changeCatalog(this)">
      ...
      <select name="Post[special_id]">
        ...
        <?php foreach((array)iCC::getList('Special', '_special') as $speical):?>
  ...
  <tr >
    <td ><?php echo $form->textField($model,'tags',array('size'=>50,'maxlength'=>255)); ?>
      <input type="btn btn-primary btn-sm" value="自动提取" onclick="keywordGet('Post_title', 'Post_tags')"/></td>
  </tr>
  <tr>
  ...
  <tr class="submit">
    <td colspan="2" ><input name="oAttach" type="hidden" value="<?php echo $model->attach_file ?>" />
      ...
      <input type="submit" name="editsubmit" value="提交" class="btn btn-primary btn-sm" tabindex="3" /></td>
  </tr>
</table>
