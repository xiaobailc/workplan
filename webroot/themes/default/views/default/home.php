...
<table class="content_list">
  ...
  <tr>
    ...
    <td ><?php echo $this->_icc?> <?php echo $this->_iccRelease?></td>
  </tr>
  <tr>
    <td >产品支持</td>
    <td ><a href="http://www.icntv.tv" target="_blank">www.icntv.tv </a><a href="http://www.icntv.tv/help" target="_blank">使用手册</a></td>
  </tr>
  <tr>
    <td >操作系统软件</td>
