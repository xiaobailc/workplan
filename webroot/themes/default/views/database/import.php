...
<div id="contentHeader">
  ...
  <div class="searchArea">
    <p class="left" >
      <a href="<?php echo $this->createUrl('database/import')?>"  class="btn btn-info btn-sm">数据库还原</a>
  ...
  <table class="content_list">
    ...
    <tr class="submit">
      <td colspan="6" ><input name="command" type="hidden" value="deleteFile" />
        ...
        全选
        <input name="submit" type="submit" id="submit" value="删除" class="btn btn-primary btn-sm"/>
        &nbsp;</td>
    </tr>
  </table>
</form>
