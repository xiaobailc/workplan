  ...
  <div class="mainBox">
    ...
    <div class="listBox clear">
      <ul class="title">
        ...
        <li class="cl ">
          <h2>
            <p class="y"> <span class="date"><?php echo date('Y-m-d H:i:s',$iccRow->post->create_time) ?></span></p>
            <a href="<?php echo $this->createUrl('post/show',array('id'=>$iccRow->post->id))?>" target="_blank" class="title" <?php if($iccRow->post->title_style):?>style="<?php echo $iccRow->post->title_style?>"<?php endif?>><?php echo $iccRow->post->title?></a> </h2>
        </li>
        <?php endforeach?>
      </ul>
    </div>
