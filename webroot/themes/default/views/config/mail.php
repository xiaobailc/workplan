...
<form action="" method="post"  enctype="multipart/form-data" id="mailConfig">
  <table class="content_list">
    ...
    <tbody id="mail_smtp_auth" >
      ...
      <tr class="submit">
        <td ><input type="submit" name="editsubmit" value="提交" class="btn btn-primary btn-sm" tabindex="3" />
          &nbsp;&nbsp;&nbsp;
          <input type="btn btn-primary btn-sm" name="mailtest" value="测试发送" class="btn btn-primary btn-sm" tabindex="3" id="mailtest" /></td>
      </tr>
  </table>
</form>
